...
GHOST_COLORS = []
GHOST_COLORS.append(formatColor(1.0,1.0,0.0)) # Yellow
GHOST_COLORS.append(formatColor(1.0,0.0,0.0)) # Red
GHOST_COLORS.append(formatColor(0.6,0.85,0.9)) # Blue
GHOST_COLORS.append(formatColor(1.0,0.0,1.0)) # Pink*
GHOST_COLORS.append(formatColor(1.0,0.5,0.0)) # Orange*
GHOST_COLORS.append(formatColor(0.15,0.7,0.3)) # Green*
GHOST_COLORS.append(formatColor(0.5,0.0,1.0)) # Purple*
GHOST_COLORS.append(formatColor(1.0,1.0,0.0)) # Yellow


TEAM_COLORS = GHOST_COLORS[:4]
...
PACMAN_SCALE = 0.5
# pacman_speed = 0.25   # this doesn't do anything.
...
class InfoPane:
  ...
  def drawPane(self):
    self.scoreText = text(self.toScreen(0, -self.base), self.textColor, "SCORE:    0", "Times", self.fontSize, "bold")
